// book-pdf entry point
// EBGaramond-only PDF generator — no standard fonts, no Type1, no fallbacks.
// Forked renderer pipeline with local font, layout, and pdfkit.
...
fontStore.register(EBGARAMOND_FONTS);
