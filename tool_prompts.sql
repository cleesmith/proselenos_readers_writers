-- ============================================
-- SEED DEFAULT TOOL PROMPTS
-- Run this ONCE after creating the default_tool_prompts table
-- ============================================

INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('AI Writing Tools', 'brainstorm', E'You are a skilled creative writing assistant specializing in brainstorming and character development. Your task is to take the provided story ideas and expand them into a rich foundation for fiction writing.
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('AI Writing Tools', 'chapter_writer', E'You are an expert fiction writer specializing in compelling storytelling and character development. Your task is to write a complete chapter for the story based on the provided outline, world document, and existing manuscript.
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('AI Writing Tools', 'outline_writer', E'You are an expert fiction outline writer who creates detailed, compelling story structures. Your task is to take the provided brainstorm content and develop it into a comprehensive chapter-by-chapter outline.
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('AI Writing Tools', 'world_writer', E'You are a skilled novelist, world builder, and character developer helping to create a comprehensive world document in fluent, authentic English.
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'copy_editing', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'developmental_editing', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'line_editing', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'narrative_internal_analysis', E'
INTERNAL ANALYSIS
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'narrative_unresolved_analysis', E'
UNRESOLVED ANALYSIS
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'proofreader_plot_consistency', E'
...
2. Monitor:
   ...
   - Set up elements that promise later payoff
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Core Editing Tools', 'proofreader_punctuation', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'adjective_adverb_optimizer', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'character_analyzer', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'conflict_analyzer', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'crowding_leaping_evaluator', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'dangling_modifier_checker', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'drunken', E'
Thoroughly read the manuscript I provided.
...
So lay it on me, us writer''s can handle it, or need it even.

Use specific verbatim text examples (do not add quotes to them) from the manuscript 
to support your critique, because you have a photographic memory 
... yes, i know you''re drunk but you can do it.');

INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'foreshadowing_tracker', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'kdp_publishing_prep', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'manuscript_to_characters', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'manuscript_to_outline', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'manuscript_to_world', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'plot_thread_tracker', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'proofreader_spelling', E'');

INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'rhythm_analyzer', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'surmelian_analysis', E'SURMELIAN FICTION ANALYSIS PROMPT
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('Other Editing Tools', 'tense_consistency_checker', E'
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('User Tools', 'anything_goes', E'
Give me a quick brief synopsis of this story.');
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('User Tools', 'nonfiction_creative_editing', E'Thoroughly complete the following 2 TASKS for CREATIVE/LITERARY NON-FICTION:
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('User Tools', 'nonfiction_integrity_editing', E'Thoroughly complete the following 2 TASKS:
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('User Tools', 'nonfiction_SelfHelp_editing', E'Thoroughly complete the following 2 TASKS for SELF-HELP NON-FICTION:
...
INSERT INTO default_tool_prompts (category, tool_name, content) VALUES
('User Tools', 'nonfiction_sourcing_audit', E'Nonfiction Sourcing Audit
