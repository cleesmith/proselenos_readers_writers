import { lockScreenOrientation } from '@/utils/desktop-stubs';
...
const FoliateViewer: React.FC<{
  ...
  const docLoadHandler = (event: Event) => {
    ...
    if (detail.doc) {
      ...
      // Inline scripts in desktop platforms are not executed by default
      if (viewSettings.allowScript && isDesktopAppPlatform()) {
