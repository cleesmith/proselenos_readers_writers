...
const LangPanel: React.FC<SettingsPanelPanelProp> = ({ bookKey, onRegisterReset }) => {
  ...
  // Translation state commented out
  ...
  const handleReset = () => {
    resetToDefaults({
      ...
      // Translation resets commented out
  ...
  // Translation functions commented out
  /*
  ...
  */
  ...
  // Translation useEffect hooks commented out
  /*
  useEffect(() => {
  ...
  */
  ...
  return (
    <div className={clsx('my-4 w-full space-y-6')}>
      ...
      {/* Translation section commented out */}
      {/* <div className='w-full'>
