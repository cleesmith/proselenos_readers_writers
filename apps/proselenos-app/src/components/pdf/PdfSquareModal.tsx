  ...
  return (
    <div className='fixed inset-0 z-[60] flex items-center justify-center bg-base-100'>
      <div className='text-center max-w-sm px-4'>
        {/* PDF icon */}
        <div className='mb-4'>
          <svg className='mx-auto text-blue-500' width='48' height='48' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'>
        ...
        {/* Progress bar — blue/indigo gradient to distinguish from 6×9 red */}
